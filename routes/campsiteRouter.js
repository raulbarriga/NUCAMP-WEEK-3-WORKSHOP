...
//you don't authenticate.verifyUser for get request since it's just a read functionality,
//but all else that modifies will need to be checked for proper credentials
campsiteRouter
    .route("/")
    .get((req, res, next) => {
        Campsite.find()
